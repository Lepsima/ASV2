...
public struct Force2 : IAutoUnit2 {
    ...
    public static Force2 Millinewton(float x, float y) => new(x * 0.001f, y * 0.001f);
    public static Force2 Millinewton(Vector2 v) => new(v.x * 0.001f, v.y * 0.001f);

    public Vector2 ToNewton() => new(x * 1f, y * 1f);
    public static Force2 Newton(float x, float y) => new(x * 1f, y * 1f);
    public static Force2 Newton(Vector2 v) => new(v.x * 1f, v.y * 1f);

    public Vector2 ToKilonewton() => new(x * 0.001f, y * 0.001f);
    public static Force2 Kilonewton(float x, float y) => new(x * 1000f, y * 1000f);
    public static Force2 Kilonewton(Vector2 v) => new(v.x * 1000f, v.y * 1000f);

    public Vector2 ToMeganewton() => new(x * 1E-06f, y * 1E-06f);
    public static Force2 Meganewton(float x, float y) => new(x * 1000000f, y * 1000000f);
    public static Force2 Meganewton(Vector2 v) => new(v.x * 1000000f, v.y * 1000000f);
    ...
    public Force2(Accel2 a, Mass b) : this(a.Force2(b)) { }
    public Force2(Mass b, Accel2 a) : this(a.Force2(b)) { }
    ...
    public Force2(ForceAccel2 a, Time b) : this(a.Force2(b)) { }
    public Force2(Time b, ForceAccel2 a) : this(a.Force2(b)) { }

    public Torque2 Torque2(Position2 v) => new(v.x * x, v.y * y);
    public Position2 Position2(Torque2 v) => new(v.x / x, v.y / y);

    public Force2(Torque2 a, Position2 b) : this(a.Force2(b)) { }
    public Force2(Position2 b, Torque2 a) : this(a.Force2(b)) { }
