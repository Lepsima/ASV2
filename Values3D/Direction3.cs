...
public struct Direction3 : IAutoUnit3 {
    ...
    public static implicit operator Vector3(Direction3 v) => new(v.x, v.y, v.z);
    ...
    public static Torque3 operator *(Torque left, Direction3 right) => new(left.vector * right.vector);
    public static Torque3 operator *(Direction3 left, Torque right) => new(left.vector * right.vector);

    public static TorqueAccel3 operator *(TorqueAccel left, Direction3 right) => new(left.vector * right.vector);
    public static TorqueAccel3 operator *(Direction3 left, TorqueAccel right) => new(left.vector * right.vector);

    public Vector3 ToNormal() => new(x * 1f, y * 1f, z * 1f);
    public static Direction3 Normal(float x, float y, float z) => new(x * 1f, y * 1f, z * 1f);
    public static Direction3 Normal(Vector3 v) => new(v.x * 1f, v.y * 1f, v.z * 1f);

    public Vector3 ToDir() => new(x * 1f, y * 1f, z * 1f);
    public static Direction3 Dir(float x, float y, float z) => new(x * 1f, y * 1f, z * 1f);
    public static Direction3 Dir(Vector3 v) => new(v.x * 1f, v.y * 1f, v.z * 1f);
