...
public struct Mass : IAutoUnit {
    ...
    public static Mass Gram(float x) => new(x * 0.001f);

    public float ToKilogram() => x * 1f;
    public static Mass Kilogram(float x) => new(x * 1f);

    public float ToTon() => x * 0.001f;
    public static Mass Ton(float x) => new(x * 1000f);

    public float ToKiloton() => x * 1E-06f;
    public static Mass Kiloton(float x) => new(x * 1000000f);
    ...
    public Mass(Force a, Accel b) : this(a.Mass(b)) { }
    public Mass(Accel b, Force a) : this(a.Mass(b)) { }

    public Torque Torque(AngleAccel v) => new(v.x * x);
    public AngleAccel AngleAccel(Torque v) => new(v.x / x);

    public Mass(Torque a, AngleAccel b) : this(a.Mass(b)) { }
    public Mass(AngleAccel b, Torque a) : this(a.Mass(b)) { }
